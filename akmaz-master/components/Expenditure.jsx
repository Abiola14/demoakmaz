...
export default function Expenditure() {
  ...
  const [ackSubmitting, setAckSubmitting] =
    useState(false);
    ...
    try {
      ...
      const normalized = res.data.map((e) => ({
        ...
        acknowledgmentStatus:
          e.acknowledgmentStatus ??
          e.AcknowledgmentStatus ??
          null,

        acknowledgmentNotes:
          e.acknowledgmentNotes ??
          e.notes ??
          e.Notes ??
          null,
      }));
  ...
  const handleAdd = async (e) => {
    ...
    try {
      ...
      setMessage({
        text: "Expenditure recorded successfully!",
        type: "success",
      });
  ...
  const canAuditorAcknowledge = (exp) => {
    return (
      !exp.isAcknowledged &&
      exp.acknowledgmentStatus !== "Approved"
    );
  };
  ...
  const handleAcknowledge = async () => {
    ...
    const notes = ackForm.notes.trim();

    // Rejection reason is mandatory
    if (
      ackForm.status === "Rejected" &&
      !notes
    ) {
      setMessage({
        text:
          "Please provide a reason for rejecting this expenditure.",
        type: "danger",
      });
    ...
    try {
      ...
      setMessage({
        text:
          ackForm.status === "Rejected"
            ? "Expenditure rejected. The Admin can now see the reason."
            : "Expenditure approved successfully!",
        type: "success",
      });
  ...
  const handleEdit = async () => {
    ...
    try {
      const endpoint = isSuperAdmin
        ? `${API_URL}/expenditures/superadmin-edit/${editModal.id}`
        : `${API_URL}/expenditures/edit/${editModal.id}`;
      ...
      setMessage({
        text: isSuperAdmin
          ? "Expenditure updated successfully by Super Admin."
          : "Expenditure updated and resubmitted. Auditor will review it again.",
        type: "success",
      });
  ...
  const handleSuperAdminDelete = async (exp) => {
    ...
    try {
      await axios.delete(
        `${API_URL}/expenditures/superadmin-delete/${exp.id}`,
        authHeaders()
      );

      setMessage({
        text: "Expenditure deleted successfully by Super Admin.",
        type: "success",
      });
  ...
  // ONLY APPROVED EXPENDITURES COUNT AS TOTAL EXPENDITURE
  ...
  const statusBadgeClass = (exp) => {
    if (!exp.isAcknowledged) {
      return "ex-badge--pending";
    }

    if (
      exp.acknowledgmentStatus ===
      "Approved"
    ) {
      return "ex-badge--approved";
    }
  ...
  const adminAction = (exp) => {
    ...
    if (!exp.isAcknowledged) {
      return (
        <span className="ex-awaiting-text">
          Awaiting review
        </span>
      );
    }
    ...
    if (
      ...
      return (
        <span className="ex-acknowledged-text">
          ✓ Verified
        </span>
      );
    }
  ...
  return (
    <div className="ex-page">
      ...
      <div className="ex-header">
        ...
        <div className="ex-header__icon">
          <MdReceiptLong size={28} />
        </div>

        <div>

          <h1 className="ex-header__title">
            Expenditures
          </h1>
          ...
          <p className="ex-header__sub">
            ...
            {isAdmin &&
              "Record and manage expenditure entries"}

            {isAuditor &&
              "Review and acknowledge expenditure records"}

            {isSuperAdmin &&
              "Manage and correct all expenditure records"}
      ...
      {message && (
        <div
          className={`ex-alert ex-alert--${message.type}`}
        >
      ...
      <div className="ex-summary">
        ...
        <div className="ex-stat">
          ...
          <div className="ex-stat__icon ex-stat__icon--total">
            <TbCurrencyNaira size={20} />
          </div>

          <div className="ex-stat__body">

            <span className="ex-stat__label">
              Total Expenditure
            </span>
        ...
        <div className="ex-stat">
          ...
          <div className="ex-stat__icon ex-stat__icon--pending">
            <FiClock size={20} />
          </div>
        ...
        <div className="ex-stat">
          ...
          <div
            className="ex-stat__icon ex-stat__icon--rejected"
          >
      ...
      {isAuditor && (
        <div className="ex-notice">
          ...
          You are in{" "}
          <strong>Auditor Mode</strong>
          {" "}— you can review and acknowledge
          expenditures but not add or edit them.
      ...
      {isSuperAdmin && (
        <div className="ex-notice">
          ...
          {" "}— you can edit or delete any expenditure record.
        </div>
      )}
          ...
          >
            ...
            <div className="ex-form__fields">
              ...
              <div className="ex-field ex-field--wide">
                ...
                <input
                  type="text"
                  placeholder="e.g. Fuel purchase, monthly PHCN bill..."
                  value={
                    form.description
                  }
                  onChange={(e) =>
      ...
      <div className="ex-search-bar">
        ...
        <div className="ex-search-input">
          ...
          <input
            type="text"
            placeholder="Search by type, description, recorded by..."
            value={search}
            onChange={(e) =>
      ...
      <div className="ex-table-card table-border">
        ...
        <div className="ex-table-wrap">
          ...
          {loading ? (
            <div className="ex-table__loading">
                  ...
                  filtered.map(
                    (exp, i) => (
                      ...
                      <tr key={exp.id}>
                        ...
                        <td className="ex-table__desc">
                          {exp.description ||
                            "-"}
                        </td>

                        <td className="ex-table__amount">
                          ₦{fmt(exp.amount)}
                        </td>

                        <td className="ex-table__name">
                          {exp.createdBy ||
                            "-"}
                        </td>
                        ...
                        <td>
                          ...
                          <span
                            className={`ex-badge ${statusBadgeClass(
                              exp
                            )}`}
                          >
                          ...
                          <td>
                            ...
                            {isAuditor && (
                              <>
                                ...
                                {canAuditorAcknowledge(
                                  exp
                                ) && (

                                  <button
                                    className="ex-ack-btn"
                                    onClick={() =>
                                      openAckModal(
                                        exp
                                      )
              ...
              <div className="ex-field">
                ...
                <textarea
                  ...
                  placeholder={
                    ackForm.status ===
                    "Rejected"
                      ? "Explain the error or correction required..."
        ...
        >
          ...
          >
            ...
            {!isSuperAdmin && (
              <>
                <div
                  className="ex-modal__flag-notice"
                  style={{
                    margin: "0 20px 0",
                  }}
                >
